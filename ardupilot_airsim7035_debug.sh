...
sim_vehicle.py -v ArduCopter -f $SIM_VEHICLE $REINIT_SITL --sim-address=$WSL_HOST_IP -A "--serial5=uart:$UART_ERLS:420000" --out=udp:$WSL_HOST_IP:14550 --out=udp:$WSL_HOST_IP:14552 --osd -D --console